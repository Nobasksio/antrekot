<template>
  ...
  >
    ...
    <q-dialog v-model="dialog" maximized>
      <q-card style="width: 100%; height: 100%" class="bg-white column">
        <div class="map_mobile col-8">
        ...
        <div class="col-4 text-white active_card_contact q-expansion-item--expanded text-uppercase q-px-none">
