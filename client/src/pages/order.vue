        ...
        <q-card class="bg-white basket" >
          ...
          <q-card-section class="q-pt-none" v-if="!thanks" >
            ...
            <div >
              ...
              <div class="q-mt-md q-mb-md">
                <div class="text-subtitle2 q-mb-sm">Доставить заказ в костюме быка Антрекот - 200р:</div >
                <q-btn @click="costume = !costume" :color="!costume ? 'primary' : 'secondary'" :label="!costume ? 'добавить' : 'добавлено'" />
              </div>
              <div class="q-py-sm" >
                <q-input
                  label="адрес"
