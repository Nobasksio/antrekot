    ...
    <q-page class="" style="height: 1px" >
        ...
        <div class=" mregular full-height" >
            ...
            <div class="row full-height" >
                <div class="col-md-4 col-12 q-px-xl " v-if="!thanks" >
                ...
                <div class="col-md-4 col-12 q-ps-xl column text-white content-centers justify-between" v-else >
...
<script >
    ...
    export default {
        ...
        meta:{
            ...
            meta: {
                description: { name: 'description', content: 'Отзывы Гриль-бар Антрекот в иркутске рад приветствовать своих гостей. На сайте вы сможете ознакомиться с меню ресторана Антрекот посмотреть интерьеры шашлыкбара Антрекот в Иркутске и узнать об акциях кафе атрекот в иркутске' },
